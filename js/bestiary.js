...
const BESTIARY = [
  ...
  { group: 'SUMMONED', kind: 'worker', name: 'Worker Bee', where: 'the Hive\'s ten haulers', castle: 'none - it hauls',
    text: 'Ten of them drag the Hive in on strands. Nothing can be hit until the nest is all the way on the page; then the haulers can, and the nest only stops coming once the last one is down.',
    scene: 'haul' },
  { group: 'SUMMONED', kind: 'bee', name: 'Swarm Bee', where: 'eight out of the Hive for every 25 damage', castle: '1 segment',
  ...
  { group: 'BOSSES', kind: 'hive', name: 'The Hive', where: 'wave 10 (the other half), random in endless', castle: '1 segment',
    text: 'Three fights in one. Hauled in by ten workers and untouchable until it is on the page; then 200 HP that lets eight bees out for every 25 you put in; then the Queen walks out of the wreck.',
    scene: 'hive' },
